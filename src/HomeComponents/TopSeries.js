...
export default function TopSeries(){
   ...
   useEffect(()=>{
    fetch('https://streaming-availability.p.rapidapi.com/search/basic?country=us&service=netflix&type=series&genre=18&page=3&output_language=en&language=en', options)
   ...
   useEffect(()=>{
    fetch('https://streaming-availability.p.rapidapi.com/search/basic?country=us&service=netflix&type=series&genre=18&page=4&output_language=en&language=en', options)
    .then(response => response.json())
    .then(response => {console.log(response)
   ...
   return (
    <div>
        <h1 className="text-2xl pl-3 sm:text-4xl sm:pl-10">Top Series</h1>
